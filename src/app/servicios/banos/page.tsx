...
export const metadata: Metadata = { title: 'Remodelación de Baños', description: 'Transformación completa de baños con acabados premium en Carabobo.' };

export default function BanosPage() {
  const svc = services.find(s => s.slug === 'banos')!;
  const other = services.filter(s => s.slug !== 'banos').slice(0, 3);
    ...
    <>
      <section className="relative min-h-[60vh] flex items-end overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
          ...
          <h1 className="text-4xl md:text-6xl font-black leading-tight mb-4">Remodelación de <span className="text-brand">Baños</span></h1>
          <p className="text-lg text-white/50 max-w-xl">Transformamos tu baño en un espacio de confort y elegancia con acabados premium.</p>
      ...
      <section className="py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-3xl font-black mb-6">Tu baño, <span className="text-brand">renovado</span></h2>
              <p className="text-white/60 text-lg leading-relaxed mb-8">{svc.longDescription}</p>
              <a href={`https://wa.me/${siteConfig.phoneWa}?text=Hola! Quiero remodelar mi baño.`} target="_blank" className="btn-glow px-8 py-4 text-base font-semibold text-white rounded-xl inline-flex items-center gap-2"><MessageCircle className="w-5 h-5" />Presupuesto para mi Baño</a>
            </div>
            <div>
      ...
      <section className="py-16 bg-dark-100/50 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-black mb-8">Galería de Baños</h2>
